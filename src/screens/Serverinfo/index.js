  ...
  return (
    <Container>
      <div className="panel panel-default mx-auto">
        <div className="panel-heading">Serverinfo</div>
        <div className="panel-body">
          <table className="table table-striped">
            <tbody>
              <tr>
                <td colSpan={2}>
                  The exp and skill rates are staged and there is little
                  variation in skill rates between different vocations to
                  ...
                  <br />
                  Starting as 10x, at level 10, and gradually decreasing to 2x,
                  at level 100.
                </td>
              </tr>
              <tr>
